...
let i = !1;
function o() {
  return "CL v25.000 (internal id 1394882f @ 2023-05-22T15:05:42.670Z)";
}
const s = class {
  constructor(n) {
    var o;
    ...
    (null === (o = n.overrides) || void 0 === o
      ...
      this._options.debug &&
        (i ||
          ((i = !0),
          console.log(
            "Using CL v25.000 (internal id 1394882f @ 2023-05-22T15:05:42.670Z)"
          ))),
      this._create();
  }
  setDebugMode(t) {
  ...
  _render(t) {
    ...
    const i = (function (t, e) {
      ...
      const o = new URL(`${t || ""}`, location.href).href,
        s = JSON.parse(
          '["bundles/runtime.04214899cac17f000613.js","bundles/__LANG__.137.72f123ce0fa2a1d14aff.js","bundles/6783.6a1bfc6cd105f6a266ca.css","bundles/6783.6a1bfc6cd105f6a266ca.rtl.css","bundles/6151.129f302a262c92b6bcf4.js","bundles/library.6297b1e4665eaf652aeb.js"]'
        ),
        ...
        l = `\n${(function (t, e, n) {
          ...
          for (const a of t)
            a.endsWith(".js")
              ? i.push(
                  `<script defer crossorigin="anonymous" src="${a.replace(
                    "__LANG__",
                    n
                  )}"><\/script>`
                )
              : s.test(a) &&
                e === r.test(a) &&
                o.push(`<link type="text/css" href="${a}" rel="stylesheet"/>`);
          return [...i, ...o].join("\n");
        })(s, "rtl" === a.dir, r)}\n`;
