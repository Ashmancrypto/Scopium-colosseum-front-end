...
const ProfileHeader = ({ 
  ...
  return (
    <div className={`backdrop-blur-md rounded-xl border p-4 sm:p-6 lg:p-8 mb-4 lg:mb-6 transition-colors duration-300 ${
      isDark 
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between space-y-4 sm:space-y-0">
        <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4 lg:space-x-6">
          ...
          <div className="relative">
            <div className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center border-3 p-3 transition-colors duration-300 ${
              isDark ? 'bg-gray-700 border-gray-600' : 'bg-gray-200 border-gray-300'
            }`}>
              <img 
                src={`${BACKEND_URL}${userProfile?.avatar}` || '/default-avatar.png'} 
                alt="Default Avatar" 
            ...
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 mb-2">
              ...
              {isOwnProfile && (
                <div className={`font-medium text-sm sm:text-base transition-colors duration-300 ${
                  ...
                  <span className={`text-xs sm:text-sm ml-2 transition-colors duration-300 ${
        ...
        {isOwnProfile ? (
          <button 
            ...
            className={`flex items-center justify-center space-x-2 px-3 sm:px-4 py-2 border rounded-lg transition-colors text-sm sm:text-base w-full sm:w-auto ${
              isDark 
          ...
          <button className={`flex items-center justify-center space-x-2 px-3 sm:px-4 py-2 border rounded-lg transition-colors text-sm sm:text-base w-full sm:w-auto ${
            isDark 
