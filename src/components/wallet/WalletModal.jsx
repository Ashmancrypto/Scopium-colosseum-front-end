...
const WalletModal = ({ userData, isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className={`rounded-2xl shadow-2xl w-full max-w-72 border relative transition-colors duration-300 ${
          isDark 
      ...
      >
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto p-4">
          ...
          <button
            ...
            className={`w-fit mx-auto flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 border ${
              isDark 
          ...
          >
            ...
            <Edit className={`w-4 h-4 transition-colors duration-300 ${
          ...
          <div className="flex flex-col items-center space-y-3 p-3">
            ...
            <div className="relative flex justify-center">
              <img 
                src="/images/logo.svg" 
                alt="Default Avatar" 
                className={`w-12 h-12 rounded-full object-cover p-2 transition-colors duration-300 ${
          ...
          <div className="p-3 text-center">
            <div className="flex items-center justify-center space-x-2">
              <span className={`font-medium text-sm font-mono transition-colors duration-300 ${
                isDark ? 'text-white' : 'text-gray-900'
              }`}>
